  ...
  template: `
    <section class="relative h-screen flex items-center justify-center text-center px-4 overflow-hidden bg-jacquier-dark">
      <div class="absolute inset-0 z-0">
        <img [ngSrc]="siteSettings.image('cateringHero', '/og-image.png').url" priority fill class="object-cover opacity-50" [alt]="siteSettings.image('cateringHero', '').altText || 'Service Traiteur & Événementiel'" referrerPolicy="no-referrer">
