    ...
    <section class="py-24 lg:py-32 bg-jacquier-primary px-4 relative overflow-hidden">
      ...
      <div class="max-w-5xl mx-auto text-center relative z-10">
        ...
        <p class="text-xl lg:text-2xl font-light text-jacquier-light mb-12 max-w-3xl mx-auto leading-relaxed">
          Envoyez votre demande ou contactez directement le restaurant pour discuter de votre événement.
        </p>
        <div class="flex flex-col sm:flex-row gap-6 justify-center items-center">
          @if (siteSettings.publicInfo().phone) {
            <a [href]="phoneHref()" class="w-full sm:w-auto flex items-center justify-center px-10 py-5 bg-jacquier-gold text-jacquier-dark rounded-xl font-bold uppercase tracking-widest hover:bg-white transition-all duration-300 shadow-xl min-h-[44px] text-sm group">
