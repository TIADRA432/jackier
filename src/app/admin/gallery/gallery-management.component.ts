...
export class GalleryManagementComponent implements OnInit {
  ...
  ngOnInit() {
    this.images$ = this.galleryService.getGalleryImages();
  }
  ...
  openDialog() {
    ...
    dialogRef.afterClosed().subscribe(result => {
      if (result) {
        this.galleryService.addGalleryImage({
          ...result,
  ...
  deleteImage(id: string) {
    if (confirm('Are you sure you want to delete this image?')) {
      this.galleryService.deleteGalleryImage(id).then(() => {
...
@Component({
  ...
  template: `
    ...
    <mat-dialog-actions align="end">
      ...
      <button mat-raised-button color="primary" [mat-dialog-close]="form.value" [disabled]="form.invalid">Upload</button>
    </mat-dialog-actions>
  `,
  styles: [`
    mat-form-field {
